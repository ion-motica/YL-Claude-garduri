...
- [ ] 9. Integrarea gardurilor in Claude Code Web / YouLearn
  ...
  - [ ] instalare efectiva in Cloud Environment `Default`
  - [ ] confirmare `yl-claude-garduri@skills-dir` = loaded
  - [ ] confirmare end-to-end: prompt `CP` -> noul Claude Code notice + reminder injectat
