...
const UPDATE_FOLDER = "Hook UserPromptSubmit - cand trimit prompt update all garduri din github";
const REMINDER_FOLDER = "Hook UserPromptSubmit - cand trimit prompt insereaza reminder";
const ENTRY_REL = `${UPDATE_FOLDER}/handler_de_hook_UserPromptSubmit_pt_ciocanitoare.mjs`;
const WORKER_REL = `${REMINDER_FOLDER}/program_ciocanitoare_dupa_actualizarea_gardurilor.mjs`;
const PORTAR_REL = `${UPDATE_FOLDER}/program_portar_actualizare_intreg_plugin_din_GitHub_inainte_de_fiecare_prompt.mjs`;
const DETECTOR_REL = `${UPDATE_FOLDER}/motor_detectare_hooks_skills_si_componente_noi_la_actualizare.mjs`;
const VALIDATOR_REL = `${UPDATE_FOLDER}/config-validator.mjs`;
const MOTOR_REMINDERE_REL = `${REMINDER_FOLDER}/motor_alegere_reminder_de_inserat.mjs`;
