...
const ENTRY_REL = "Hook UserPromptSubmit - cand trimit prompt/handler_de_hook_UserPromptSubmit_pt_ciocanitoare.mjs";
const WORKER_REL = "Hook UserPromptSubmit - cand trimit prompt/program_ciocanitoare_dupa_actualizarea_gardurilor.mjs";
const PORTAR_REL = "Hook UserPromptSubmit - cand trimit prompt/program_portar_actualizare_intreg_plugin_din_GitHub_inainte_de_fiecare_prompt.mjs";
const DETECTOR_REL = "Hook UserPromptSubmit - cand trimit prompt/motor_detectare_hooks_skills_si_componente_noi_la_actualizare.mjs";
const VALIDATOR_REL = "Hook UserPromptSubmit - cand trimit prompt/config-validator.mjs";
const MOTOR_REMINDERE_REL = "Hook UserPromptSubmit - cand trimit prompt/motor_alegere_reminder_de_inserat.mjs";
